 ...
 * 电脑壁纸最新
 */
public class FragmentComputerNewest extends Fragment {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String PATH = HttpUtils.host + "/wallpaper/category/" + id + "/wallpaper?limit=30&skip=" + skip + "&adult=false&first=1&order=new";
